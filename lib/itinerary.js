...
export default class TriMetItinerary extends NarrativeItinerary {
  ...
  _headerText () {
    ...
    return itinerary.summary || 'Itinerary'
  }
    ...
    return (
      <div className='leg-body'>
        <div onClick={() => this._onHeaderClick()} className='header'>
          ...
          {leg.mode} {OtpUtils.time.formatDuration(leg.duration)}
  ...
  render () {
    ...
    return (
      <div className='transit-leg-details'>
        <div onClick={() => this._onHeaderClick()} className='header'>
          {leg.duration && <span>Travel {OtpUtils.time.formatDuration(leg.duration)}</span>}
