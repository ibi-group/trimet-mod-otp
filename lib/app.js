...
import {
  MobileResultsScreen as OtpMobileResultsScreen,
  MobileSearchScreen as OtpMobileSearchScreen,
  ResponsiveWebapp,
  otpUtils
...
const {
  ...
  MainPanel,
  MapWindows,
  MobileResultsScreen = OtpMobileResultsScreen,
  MobileSearchScreen = OtpMobileSearchScreen,
  ModeIcon,
  TermsOfService,
  TermsOfStorage
} = jsConfig
...
if (
  ...
  throw new Error('ItineraryBody, getMainPanel, LegIcon, and ModeIcon must be defined in config.js')
}
