...
const {getItineraryFooter, getMainPanel, LegIcon, ModeIcon} = jsConfig
...
if (otpConfig.datastoreUrl) {
  ...
  mainPanel = <BatchRoutingPanel LegIcon={LegIcon} ModeIcon={ModeIcon} />
}
// if (typeof getMainPanel === 'function') {
//   console.log('Overriding main panel.')
//   const overridePanel = getMainPanel()
//   if (overridePanel) mainPanel = overridePanel
// }
