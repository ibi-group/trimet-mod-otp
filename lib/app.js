...
const {getItineraryFooter, getContainerSlot, getMapContainerSlot, getMainPanel, LegIcon, ModeIcon} = jsConfig
...
const itineraryFooter = typeof getItineraryFooter === 'function'
  ? getItineraryFooter()
  : null
let mainPanel = typeof getMainPanel === 'function' && getMainPanel()
if (!mainPanel) {
  mainPanel = (
    <DefaultMainPanel
...
const mapContainerSlot = typeof getMapContainerSlot === 'function' && getMapContainerSlot()
const containerSlot = typeof getContainerSlot === 'function' && getContainerSlot()
