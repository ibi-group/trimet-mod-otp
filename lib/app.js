...
class TrimetWebapp extends Component {
  ...
  _updateMobileScreen (props) {
    ...
    const hasSearchResults = props.activeSearchId !== null
...
const mapStateToProps = (state, ownProps) => {
  ...
  return {
    ...
    resultCount: activeSearch && activeSearch.response
      ? activeSearch.query.routingType === 'ITINERARY'
          ? (activeSearch.response.plan ? activeSearch.response.plan.itineraries.length : 0)
