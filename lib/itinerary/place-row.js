...
export default class PlaceRow extends Component {
  ...
  render () {
    const { leg, legIndex, place, time, timeOptions, followsTransit } = this.props
    ...
    return (
      <div className='place-row' key={this.rowKey++}>
        <div className='time'>
          {time && otpUtils.time.formatTime(time, timeOptions)}
        </div>
        ...
        <div className='place-details'>
          ...
          <div className='place-name'>
            {interline
              ...
              : <div>{otpUtils.itinerary.getPlaceName(place)}</div>
            }
          </div>
            ...
            leg.transitLeg
              ...
              : (/* This is an access (e.g. walk/bike/etc.) leg */
                <AccessLegBody
                  leg={leg}
                  legIndex={legIndex}
                  legMode={otpUtils.itinerary.getLegMode(this.props.companies, leg).legMode}
