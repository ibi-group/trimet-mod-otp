  ...
  render () {
    ...
    return (
      <div
        ...
        // FIXME: this is a bit of a hack, but the height ensures that container
        // can be swiped up when collapsed. If the value is less than the actual
        // height of the content, swiping will not work. It must be removed when
        // expanded because it interferes with div height when expanded.
        style={!expanded ? { height: '100000px' } : null}
      >
        <div
